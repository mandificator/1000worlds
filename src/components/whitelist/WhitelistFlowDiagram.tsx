...
const steps: FlowStep[] = [
  { title: "deposit $WORLDS", detail: ["min. 10,000, any number of times"] },
  { title: "worlds granted", detail: ["deposit ÷ final price, rounded down"] },
  {
    title: "refunded",
    detail: ["the rounding remainder, and anything unused, comes back to you"],
    accent: true,
  },
  { title: "burned", detail: ["the $WORLDS spent on your worlds, permanently"] },
];
